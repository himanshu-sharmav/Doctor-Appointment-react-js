...
const Contact = () => {
    ...
    return (
        <>
            <Header />
            <SubHeader title="Contact us" subtitle="Get in touch with our healthcare team for appointments, inquiries, or support. We're here to help with your medical needs." />
