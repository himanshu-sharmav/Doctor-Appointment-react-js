            ...
            <div className="col-lg-8 offset-lg-2">
                <div className="invoice-content">
                    ...
                    <div className="other-info">
                        ...
                        <p className="text-muted mb-0">This invoice represents the complete breakdown of your medical appointment charges, including consultation fees, administrative costs, and any additional services provided during your visit. All charges are transparently displayed for your convenience.</p>
                    </div>
