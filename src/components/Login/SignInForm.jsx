            ...
            <div className="panels-container">
                <div className="panel left-panel">
                    <div className="content">
                        ...
                        <p>Welcome to our comprehensive Doctor Appointment Management System. Book appointments with qualified healthcare professionals easily and securely.</p>
                ...
                <div className="panel right-panel">
                    <div className="content">
                        ...
                        <p>Already have an account? Sign in to access your appointments, medical records, and manage your healthcare journey with ease.</p>
