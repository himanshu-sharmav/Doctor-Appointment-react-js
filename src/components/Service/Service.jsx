...
const Service = () => {
  ...
  return (
    <>
      <Header />
      <SubHeader title="Service" subtitle="Comprehensive healthcare services designed to meet your medical needs with excellence and care." />
              ...
              <div className="col-lg-4 col-md-6 col-sm-6" key={id + 6}>
                <div className="card shadow border-0 mb-5">
                  ...
                  <div className="p-2">
                    ...
                    <p className="mb-4">We are committed to providing exceptional healthcare services with the highest standards of medical excellence and patient care.</p>
                  </div>
                </div>
              </div>
            ))
            ...
            <div className="col-lg-7">
              <div className="d-flex align-items-center">
                <div className='mb-4 section-title text-center'>
                  ...
                  <p className='form-text'>Please fill out the form below to schedule your appointment or inquire about our services.</p>
