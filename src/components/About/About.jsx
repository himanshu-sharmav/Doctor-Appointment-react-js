                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className='mb-4 section-title text-center'>
                            ...
                            <p className='form-text m-0'>Discover our team of highly qualified medical specialists who are dedicated to providing the best possible care for our patients.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-lg-6 offset-lg-6">
                        <div className='mb-4 section-title text-center'>
                            ...
                            <p className='form-text m-0'>Hear from our experienced medical professionals about their commitment to healthcare excellence and patient well-being.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="row align-items-center">
                    <div className="col-lg-6 offset-lg-6">
                        ...
                        <p className='form-text'>
                            Our healthcare system provides exceptional service facilities with a focus on patient care and medical excellence. Our team of dedicated professionals works tirelessly to ensure the highest standards of healthcare delivery, making us a trusted partner in your health journey.
                        </p>
                    </div>
                </div>
            </div>
