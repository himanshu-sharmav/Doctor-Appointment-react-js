				...
				<div className="row">
					<div className="col-12 col-md-3 col-lg-3">
						<div className='mb-2 section-title text-center'>
							...
							<p className='m-0 text-secondary'>Book your appointment with our qualified healthcare professionals.</p>
						</div>
						<div className="form-text">
							<p>Our user-friendly interface ensures a seamless booking experience, allowing you to focus on your health while we handle the appointment scheduling details.</p>
